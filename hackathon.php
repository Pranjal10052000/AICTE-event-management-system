...
<header class="header">
    ...
    <a href="index.php" class="logo"><span>A</span>ICTE</a>
...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>HACK<span>ATHON </span></h3>
        
    </div>

    <div class="swiper-container home-slider">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="images/hackathons/H1.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/hackathons/H4.png" alt=""></div>
            <div class="swiper-slide"><img src="images/hackathons/H2.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/hackathons/H5.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/hackathons/H6.jpg" alt=""></div>
            <div class="swiper-slide"><img src="images/hackathons/H8.png" alt=""></div>
            <div class="swiper-slide"><img src="images/hackathons/H3.png" alt=""></div>
        </div>
    </div>
...
<section class="contact" id="contact">
    ...
    <h1 class="heading"> <span>Register</span> yourself </h1>
     <a name="Click Me" id="clickme" class="btn btn-primary" href="./modules/hackthonR.php" role="button">Click Me</a>
...
<!--
    <form action="">
        ...
        <div class="inputBox">
            ...
            <input type="text" placeholder="name of hackathon">
        </div>
