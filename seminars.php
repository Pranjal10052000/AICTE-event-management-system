...
<section class="home" id="home">
    ...
    <div class="content">
        <h3>SEMI<span>NARS </span></h3>
        
    </div>

        <div class="swiper-container home-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="images/seminars/s1.jpg" alt=""></div>
                <div class="swiper-slide"><img src="images/seminars/s2.jpg" alt=""></div>
                <div class="swiper-slide"><img src="images/seminars/s3.jpg" alt=""></div>
                <div class="swiper-slide"><img src="images/seminars/s4.png" alt=""></div>
                <div class="swiper-slide"><img src="images/seminars/s5.jpg" alt=""></div>
                <div class="swiper-slide"><img src="images/seminars/s6.jpg" alt=""></div>
                <div class="swiper-slide"><img src="images/seminars/s7.jpg" alt=""></div>
...
<section class="contact" id="contact">
    ...
    <form action="">
        ...
        <div class="inputBox">
            ...
            <input type="text" placeholder="name of seminar">
        </div>
